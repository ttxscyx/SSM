...
import com.cyx.spring.controller.UserController;
import com.cyx.spring.dao.UserDao;
import com.cyx.spring.service.impl.UserServiceImpl;
...
* 可以通过标识组件的注解的value属性值设置bean的自定义的id @Controller("controller")
*
...
* 且这些bean的id和要赋值的属性的属性名都不一样，此时抛出异常：NOUniqueBeanDefinitionException
...
* 可以将required设置为false，此时能装配则装配，无法装配则使用属性的的默认值
* */
public class IOCByAnnotationTest {
    @Test
    public void test(){
        ApplicationContext ioc =new ClassPathXmlApplicationContext("spring-ioc-annoation.xml");
