...
* execution(* com.cyx.spring.aop.annotation.CalculatorImpl.*(..)
...
* @Pointcut("execution(* com.cyx.spring.aop.annotation.CalculatorImpl.*(..))")
...
public class LoggerAspect {
    ...
    //@Before("execution(public int com.cyx.spring.aop.annotation.CalculatorImpl.add(int,int))")
    ...
    public void afterAdviceMethod(JoinPoint joinPoint){
        //获取连接点所对应方法的签名信息
        Signature signature = joinPoint.getSignature();
        System.out.println("LoggerAspect,方法：后置通知"+signature.getName()+",执行完毕");
    }
